...
public class SolicitacoesContratoEditoraPage extends BasePage{
	...
	public void checkElementsOnThePage(){
		...
		Assert.assertTrue(BasePage.isElementPresent(By.xpath(".//*[@id='dce_IND_TIPO_CONTRATO_DCE'][@value='EN']")));
